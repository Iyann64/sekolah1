...
CREATE TABLE `ppdb` (
  ...
  `file_ktp_ortu` VARCHAR(255) NULL,
  `file_foto_siswa` VARCHAR(255) NULL,
  `file_imunisasi` VARCHAR(255) NULL,
  `file_surat_sehat` VARCHAR(255) NULL,
  `file_ijazah_tk` VARCHAR(255) NULL,
